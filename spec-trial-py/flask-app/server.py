...
def display_dino():
    ...
    <html>
      <head>
        <title>{dino_name} the Munchinator</title>
        <link rel="stylesheet" href="/static/main.css">
      </head>
      <body>
        <main>
            <img src="/static/images/{dino_pic}" alt="dinosaur"/>
            <h1>This is {dino_name} the Munchinator.  At a slim {age} years old, he likes long walks on the beach, living, laughing, loving, and munchinating.</h1>
            <a href="/form">Create a dino.</a>
        </main>
      </body>
    </html>
    """
